...
return array (
  ...
  'style_prop_desc.contentAltBase' => 'When an alternate background needs to be presented along side the main content background, this will be employed',
  'style_prop_desc.contentAltBg' => 'In order to differentiate it, some content will be presented on this alternate background',
  ...
  'style_prop_desc.linkUgcColor' => 'Used to color links posted by users within posts etc.',
  'style_prop_desc.linkUgcHoverColor' => 'Hover state for links in UGC',
  ...
  'style_prop_desc.pageNavBase' => 'Used to style clickable page numbers',
  'style_prop_desc.pageNavCurrent' => 'Styles the control that indicates the current page number',
  ...
  'style_prop_desc.publicLogoUrl' => 'The path from your XenForo root directory to your logo. If you specify alternate variations, they should be the same size. If you specify an SVG, you should set <b>Emails &gt; Email logo URL</b> to a PNG, or similar, for better compatibility.',
  'style_prop_desc.publicLogoUrl2x' => 'The path to a double-resolution / retina version of your logo image. If you specify alternate variations, they should be the same size.',
  ...
  'style_prop_desc.publicPwaInstallVideoUrl' => 'The path to the video instructing iOS users how to install the PWA.',
  ...
  'style_prop_desc.selectedItemBgColor' => '',
  'style_prop_desc.selectedItemBorderColor' => '',
  'style_prop_desc.selectedItemColor' => '',
