...
return array (
  ...
  'widget_pos_desc.conversation_list_sidebar' => 'Position in the sidebar while viewing a list of direct messages.',
  'widget_pos_desc.conversation_view_sidebar' => 'Position in the sidebar while viewing a direct message. Widget templates rendered in this position can use the current conversation entity in the <code>{$context.conversation}</code> param.',
  'widget_pos_desc.featured_content_list_above_features' => 'A position on the featured content list, above the list of featured content.',
  'widget_pos_desc.featured_content_list_below_features' => 'A position on the featured content list, below the list of featured content.',
  'widget_pos_desc.featured_content_list_sidebar' => 'A position on the featured content list, in the sidebar.',
  ...
  'widget_pos_desc.whats_new_sidebar' => 'Sidebar next to the standard what\'s new content',
