<?php
// FROM HASH: 8cd293abd05b8e3ec40bf24203ccfdfd
return array(
...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="thread" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	if ($__vars['findNew']['result_count']) {
		...
		$__compilerTemp3 = '';
		$__compilerTemp3 .= '
						' . $__templater->callMacro(null, 'whats_new_posts::buttons', array(
	...
	<div class="block-container">
		' . $__templater->callMacro(null, 'whats_new_posts::filter_bar', array(
		'findNew' => $__vars['findNew'],
		...
		' . $__templater->callMacro(null, 'whats_new_posts::results', array(
		'findNew' => $__vars['findNew'],
