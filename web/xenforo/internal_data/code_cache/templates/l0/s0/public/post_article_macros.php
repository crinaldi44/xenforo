<?php
// FROM HASH: f5b85962a3b3fdcba6db28bad276f9ae
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['thread']['cover_image']) {
		$__finalCompiled .= '
				<a href="' . $__templater->escape($__vars['linkUnread']) . '" class="articlePreview-image" tabindex="-1">
					<img src="' . $__templater->escape($__vars['thread']['cover_image']) . '" alt="' . $__templater->escape($__vars['thread']['title']) . '" loading="lazy" />
				</a>
			';
	}
	$__finalCompiled .= '
	...
	$__finalCompiled .= '
				...
				<div class="articlePreview-links">
					...
					<a href="' . $__templater->escape($__vars['link']) . '">' . 'View full article' . ' &raquo;</a>
				</div>
			</div>
		</div>
