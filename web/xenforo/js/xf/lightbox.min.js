((f,k)=>{XF.Lightbox=XF.Element.newHandler({options:{lbInfobar:1,lbSlideShow:1,lbThumbsAuto:1,lbUniversal:0,lbTrigger:".js-lbImage",lbContainer:".js-lbContainer",lbHistory:0,lbPrev:null,lbNext:null},fancybox:null,sidebar:null,sidebarToggle:null,initialUrl:null,prevUrl:null,nextUrl:null,thumbsInitialized:!1,lastIndex:null,isJumping:!1,pushStateCount:0,init(){this.initContainers();XF.on(k,"xf:reinit",this.checkReInit.bind(this));XF.onDelegated(k,"click","a.js-lightboxCloser",a=>{this.getInstance().close()})},
...
{const d=XF.customEvent("lightbox:loaded",{container:a,instance:b,slide:c});XF.trigger(a,d)},500)},reveal(b,c){b=XF.customEvent("lightbox:reveal",{container:a,instance:b,slide:c});XF.trigger(a,b)},"Carousel.ready Carousel.change":b=>{const c=b.getSlide();c.el.classList.add("fancybox__slide--video");b=XF.customEvent("lightbox:slide-displayed",{container:a,instance:b,slide:c});XF.trigger(a,b)},done(b,c){b=XF.customEvent("lightbox:done",{container:a,instance:b,slide:c});XF.trigger(a,b)},shouldClose(b,
c){b=XF.customEvent("lightbox:should-close",{container:a,instance:b,slide:c});XF.trigger(a,b)},close(b,c){b=XF.customEvent("lightbox:closed",{container:a,instance:b,slide:c});XF.trigger(a,b)}}}},getLanguage(){return{CLOSE:XF.phrase("lightbox_close"),NEXT:XF.phrase("lightbox_next"),PREV:XF.phrase("lightbox_previous"),ERROR:XF.phrase("lightbox_error"),PLAY_START:XF.phrase("lightbox_start_slideshow"),PLAY_STOP:XF.phrase("lightbox_stop_slideshow"),FULL_SCREEN:XF.phrase("lightbox_full_screen"),THUMBS:XF.phrase("lightbox_thumbnails"),
DOWNLOAD:XF.phrase("lightbox_download"),SHARE:XF.phrase("lightbox_share"),ZOOM:XF.phrase("lightbox_zoom"),NEW_WINDOW:XF.phrase("lightbox_new_window"),SIDEBAR_TOGGLE:XF.phrase("lightbox_toggle_sidebar")}}});XF.Lightbox.activeLb=null;XF.on(k,"xf:reinit",a=>{({element:a}=a);if(a!=k){var b=a.closest("[data-xf-init~=lightbox]");b&&(XF.Element.getHandler(b,"lightbox")||setTimeout(()=>{XF.Element.initializeElement(b)},0))}});XF.History.handle(a=>{const b=XF.Lightbox.activeLb;if(b)return b.handlePopstate(a),
!0});XF.Element.register("lightbox","XF.Lightbox")})(window,document);
